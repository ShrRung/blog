<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"E:\php_program\blog\public/../application/admin\view\login.html";i:1477464743;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="row">
        <div class="col-sm-7">
            <div class="signin-info">
                ...
                <div class="m-b"></div>
                <h4>欢迎使用 <strong>LazyCat</strong></h4>
                <ul class="m-b">
        ...
        <div class="col-sm-5">
            <form method="post" action="index.html">
                <p class="m-t-md" id="err_msg">登录到LazyCat</p>
